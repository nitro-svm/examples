pub mod titan_multi_sol_usdc_template_v3 {
...
pub mod titan_tessera_sol_usdc_template_v3 {
    pub const SOL_TO_USDC: &str =
        "4qmeBphfJdsffBTzYeAZ7PJuFRqfbbGprxccu27Z8GipDkLBBKMsG55XNjvTd2b1r5ZeuuVFWHP5wCGidLSfFHJ5";
    pub const USDC_TO_SOL: &str =
        "4mCnU4U7TBJEsjMVueypzf9q1WtrqeUuQF9uyvvbzjP4JLcqn2cbXzRuqBykpwVktG97gjnVp2Ldt4GNDYHnBB3B";
}
